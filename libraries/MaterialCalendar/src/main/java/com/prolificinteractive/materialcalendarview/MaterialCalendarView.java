...
public class MaterialCalendarView extends ViewGroup {
    ...
    private boolean needWeekdayMonthSwitchArrow;
    ...
    private static final int DAY_NAMES_ROW = 2;
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            needWeekdayMonthSwitchArrow = a.getBoolean(R.styleable.MaterialCalendarView_mcv_need_arrow, false);
            ...
            setDateTextAppearance(a.getResourceId(
                    ...
                    R.style.EmucooTextAppearance_MaterialCalendarWidget_Date
            ));
    ...
    private void setupChildren() {
        ...
        addView(topbar, new LayoutParams(2));


        if(needWeekdayMonthSwitchArrow) {
            topbar.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (calendarMode == CalendarMode.MONTHS) {
                        ...
                        title.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.drawable.icon_arrow_down);

                    } else if (calendarMode == CalendarMode.WEEKS) {

                        state().edit().setCalendarDisplayMode(CalendarMode.MONTHS).commit();
                        title.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.drawable.icon_arrow_up);
                    }
...
//            state().edit().setCalendarDisplayMode(CalendarMode.MONTHS).commit();
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                0, topbar.getHeight() * 2 / 3, DEFAULT_DAYS_IN_WEEK - 2);
