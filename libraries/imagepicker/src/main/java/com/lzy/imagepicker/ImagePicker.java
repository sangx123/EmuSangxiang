...
public class ImagePicker {
    ...
    public static int outPutX = 800;           //裁剪保存宽度
    public static int outPutY = 800;           //裁剪保存高度
    ...
    public void takePicture(Activity activity, int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(activity.getPackageManager()) != null) {
            takeImageFile = new File(Environment.getExternalStorageDirectory(), "/ImagePicker/camera/");
            /*
            ...
            */
            ...
            Log.e(TAG, "takePicture existSDCard:" + Utils.existSDCard() + "   path:" + takeImageFile.getAbsolutePath());
            ...
            if (takeImageFile != null) {
                ...
                Log.e(TAG, "takePicture: takeImageFile == null"  );
            }
        }
...
//        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.CHINA);
        String filename = prefix + System.currentTimeMillis() + (mRand.nextBoolean() ? "a" : "aa") + mRand.nextLong() + suffix;
