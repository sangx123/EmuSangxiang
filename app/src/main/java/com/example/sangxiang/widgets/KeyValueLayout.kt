package com.example.sangxiang.widgets
...
import com.example.sangxiang.utils.BitmapUtils.Companion.getNameBitmap
import com.example.sangxiang.utils.Utils
import com.example.sangxiang.work.UserModel
...
class KeyValueLayout(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : RelativeLayout(context, attrs, defStyleAttr) {
    ...
    private fun setDest(desc: String) {
        mDesc = desc
        tv_title.text = mDesc
    }
